  ...
  return (
    <Link href={href} passHref>
      <div
        ...
        } flex border-r-brand-400  my-4 `}
      >
        <a className="flex ml-7 gap-5 justify-start items-center text-brand-400 cursor-pointer hover:text-brand-300 active:text-brand-200">
          {icon}
          {children}
        </a>
      </div>
