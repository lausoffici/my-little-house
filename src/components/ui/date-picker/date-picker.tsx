...
const DateTimePicker = React.forwardRef<HTMLDivElement, DatePickerStateOptions<DateValue>>((props, forwardedRef) => {
    ...
    const birthDate = state.value ? new Date(state.value?.toString()).toISOString() : undefined;
    return (
        <div
            {...groupProps}
            ref={ref}
        ...
        >
            ...
            <input type='hidden' name='birthDate' aria-hidden value={birthDate} className='hidden' />
